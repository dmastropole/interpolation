...
for i=1:length(grids)
    ...
    %create grids
    var=create_dpthgrds(xyz_regrid,'med',t_pvar(i),t_sig(i),...
...
for j=1:length(grids)
    ...
    %create grids
    var=create_dpthgrds(xyz_regrid,'high',t_pvar(j),t_sig(j),...
        [x_range y_range],filename, LatBat);
...
for k=1:length(grids)
    ...
    %create grids
    var=create_dpthgrds(xyz_regrid,'high',t_pvar(k),t_sig(k),...
        [x_range y_range],filename, LatBat);
